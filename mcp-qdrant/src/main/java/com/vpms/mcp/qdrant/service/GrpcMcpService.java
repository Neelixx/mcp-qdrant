...
import com.vpms.mcp.qdrant.chunker.TextChunker;
import com.vpms.mcp.qdrant.client.EmbeddingServiceClient;
...
import com.vpms.mcp.qdrant.proto.CollectionInfo;
import com.vpms.mcp.qdrant.proto.CreateCollectionRequest;
import com.vpms.mcp.qdrant.proto.CreateCollectionResponse;
import com.vpms.mcp.qdrant.proto.DeleteCollectionRequest;
import com.vpms.mcp.qdrant.proto.DeleteCollectionResponse;
import com.vpms.mcp.qdrant.proto.DocumentSource;
import com.vpms.mcp.qdrant.proto.GetCollectionInfoRequest;
import com.vpms.mcp.qdrant.proto.GetCollectionInfoResponse;
import com.vpms.mcp.qdrant.proto.HybridSearchRequest;
import com.vpms.mcp.qdrant.proto.HybridSearchResponse;
import com.vpms.mcp.qdrant.proto.IngestDocumentRequest;
import com.vpms.mcp.qdrant.proto.IngestDocumentResponse;
import com.vpms.mcp.qdrant.proto.ListCollectionsRequest;
import com.vpms.mcp.qdrant.proto.ListCollectionsResponse;
import com.vpms.mcp.qdrant.proto.McpQdrantServiceGrpc;
import com.vpms.mcp.qdrant.proto.SearchResult.Builder;
import com.vpms.mcp.qdrant.repository.QdrantRepository;
...
public class GrpcMcpService extends McpQdrantServiceGrpc.McpQdrantServiceImplBase {
    ...
    private HybridSearchResponse buildResponse(List<SearchResult> results, String summary,
        ...
        for (SearchResult result : results) {
            Builder resultBuilder = com.vpms.mcp.qdrant.proto.SearchResult.newBuilder()
                    .setId(result.getId())
