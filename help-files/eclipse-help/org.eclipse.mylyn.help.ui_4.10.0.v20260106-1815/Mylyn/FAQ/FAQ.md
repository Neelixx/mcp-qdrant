---
source: FAQ.html
original_path: org.eclipse.mylyn.help.ui_4.10.0.v20260106-1815/Mylyn/FAQ/FAQ.html
---

Mylyn FAQ  
[ ![Next](../../images/next.gif) ](<Installation.html> "Installation")  
Installation  
  
* * *

[Mylyn/User Guide](<../../Mylyn/User_Guide/User-Guide.md> "Mylyn/User Guide"), [Mylyn Home](<http://eclipse.org/mylyn>), [Log in to edit](<http://wiki.eclipse.org/index.php?title=Special:Userlogin&returnto=Special:Userlogout>)

For instructions on using Mylyn, see the [Mylyn/User Guide](<../../Mylyn/User_Guide/User-Guide.md> "Mylyn/User Guide"). For instructions on developing and contributing to Mylyn, see the [Mylyn/Contributor Reference](<http://wiki.eclipse.org/Mylyn/Contributor_Reference> "Mylyn/Contributor Reference"). 

# What is Mylyn?

For **tutorials and articles on using Mylyn** refer to the **[Get Started](<http://www.eclipse.org/mylyn/start/>) ** page. 
